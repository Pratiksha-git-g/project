...
<div  id="landing-content">
              ...
              <table  className="btn btn-primary" id="pickup-btn">
                  <th>Eat Here</th>
                  <tr><td></td>
                  <td></td></tr>
...
<tr>
     ...
     <div backgrouncolor="red">
            ...
            <div>
             ...
             <table  className="btn btn-danger"onClick={this.homediver()} id="delivery-btn">
                 <th>Home Delivery</th>
...
<div id="form-group">
          ...
          <form>
            ...
            <div>
                <h2 className="text-center"> Employee of the year</h2>
                <div className="row">
